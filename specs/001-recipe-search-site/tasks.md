...
- [X] T072 [P] Surface the two findings the feature prompt did not anticipate for a decision: `Authors: TBD` on 10 recipes, and the ~10 `bf_` files whose OCR damage no label rule can recover (research.md R4, R3)
